...
- そもそも人間はハイコンテキスト（暗黙の前提を共有した状態）で仕事をしてきたので、それを全部言語化してAIに渡すのは非常に重たい、とまず感じる。
- ただ、この「言語化」を新人教育とセットで捉えると、見え方が変わってくる。
...
- 🙂 第一印象: これは本当に必要かと最初は思ったが、考えるほど本質的なテーマだと感じる。
- 👍 良い点: 暗黙知の言語化を新人教育とセットでやれば、組織の知をそのままAIに引き継げる。「組織は人に宿る」と言われるが、その知を組織（＝AI）に宿せるのではないか。むしろ誰より詳しいのがAIになる可能性がある。
- 👎 ダメな点: ハイコンテキストな暗黙知を全部言語化するのは重い。そこを引き受けて運用するルール作り・管理する人間が要る。
- 👥 誰向けか: 組織の知の継承・運用を考える人。ただし突き詰めると「その知を管理する人間もいらなくなるのでは」という問いに行き着く。
