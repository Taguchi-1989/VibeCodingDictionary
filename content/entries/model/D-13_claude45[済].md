...
- 4 と 4.5 で何が変わったのか、数字からは分かりません
- エージェントとして使える、の意味がつかみにくいです
- 自分の用途で違いが出るのかどうか判断できません
...
- 🙂 第一印象: ここで確変した、という感覚があります
- 👍 良い点: 自律的に回せる可能性が見えました
- 👎 ダメな点: それ以前は先が見通せませんでした
- 👥 誰向けか: エージェントを試したい人向けです
