...
| F-45 | デプロイ | 記入済み |
| F-46 | デバッグ | 記入済み |
| F-18 | フレームワーク／ライブラリ | つまずき・第一印象のみ。**良い点／ダメな点／誰向けか が空欄** |
...
2. **台帳にあるのにファイルが無い 27 件**（当初 35 件 → 技術寄り 8 件を消化して 27 件）：`ledgers/entries.csv` に行はあるのに `path` 列が空＝**一度も生成されていないエントリ**です。notes に「v2テンプレ本書き済」と書かれている行も含まれますが、実ファイルは存在しません。
   ...
   **残り 27 件**：`C-83 / D-3 / D-10 / D-13 / D-23 / F-34 / F-57 / F-150 / H-2 / H-3 / H-4 / H-50 / H-51 / H-52 / H-57 / H-59 / H-60 / H-61 / H-62 / H-63 / I-80 / I-81 / J-22 / J-32 / J-50 / J-55 / J-62`。**H 章の歴史・文化 9 本**（H-50 Bard→Gemini / H-51 Preview から正式版へ / H-52 Copilot から Claude Code まで / H-57 Gemini の命名史 / H-59 AI エージェント元年 / H-60 Codex→GitHub Copilot の系譜 / H-61 Preview 版という文化 / H-62 Anthropic 創業の流れ / H-63 Vibe Coding 命名）は用語カードではなく読み物の束で、毛色を変えたいときの有力候補です。G-49 AI エージェントが H-59 を関連用語に入れられなかったのもここが原因
